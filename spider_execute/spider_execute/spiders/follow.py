...
from spider_execute.items import SpiderFollowingsItem
...
class BilibiliSpider(scrapy.Spider):
    ...
    url = 'https://api.bilibili.com/x/relation/followings?vmid=%s&pn=%s&ps=50&order=desc&jsonp=jsonp'
    # 复写settings
    custom_settings = {
    ...
    def parse(self, response):
        ...
        try:
            ...
            for jsData in data['data']['list']:
                item_dict = SpiderFollowingsItem()
                item_dict['source'] = 'follow'
